...

{
    ...
    
  {
      ...
      
    {
      ...
      island_replicates[[rep]] <- DAISIE_sim_core_oceanic(time=time,mainland_n = M,pars=pars)
    ...
    
  {
    ...
    { 
        ...
        
      {
        ...
        { 	
          ...
          full_list[[m_spec]]  = DAISIE_sim_core_oceanic(time=time,mainland_n = 1,pars)
        ...
        
      {
          ...
          
        {
          ...
          { 	
            ...
            full_list[[m_spec]] = DAISIE_sim_core_oceanic(time = time,mainland_n = 1,pars = c(lac_1,mu_1,K_1,gam_1,laa_1))
          ...
          { 	
            ...
            full_list[[m_spec]] = DAISIE_sim_core_oceanic(time = time,mainland_n = 1,pars = c(lac_2,mu_2,K_2,gam_2,laa_2))
    ...
    island_replicates = DAISIE_format_CS_oceanic(island_replicates = island_replicates,time = time,M = M,sample_freq = sample_freq)
